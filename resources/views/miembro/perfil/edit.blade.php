					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<div class="input-group">
								 ...
								 <input pattern="[0-9]+" maxlength="15" type="tel" class="form-control" name="telefono"  value="{{ $user->telefono }}" onkeypress="return soloNumeros(event)" placeholder="(xxx)xxxxxx">
							</div>
						</div>
					</div>
					<!-- Campo Celular -->
					<div class="form-group">
						...
						<div class="col-sm-8">
							<div class="input-group">
								 ...
								 <input pattern="[0-9]+" maxlength="15" type="tel" class="form-control" name="celular" value="{{ $user->celular }}" onkeypress="return soloNumeros(event)" placeholder="(xxx)xxxxxxxxx">
							</div>
						</div>
					</div>
				</div>
	      ...
	      <div class="caja-header">
			...
			<div class="caja-body">
				...
				<div class="row">
					...
					<div class="col-sm-6">
						<input type="file" name="foto" class="form-control dropify" data-height="200" value="{{old('foto')}}" data-default-file="{{ asset('storage/users/avatar2.png') }}"  data-allowed-file-extensions="png jpg jpge" data-disable-remove="true">
					</div>
					<div class="col-sm-3"></div>
				</div>
			</div>
				...
				<div class="form-horizontal">
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<div class="input-group">
								 ...
								 <input type="password" class="form-control" name="passwordNow" onkeypress="return soloNumeros(event)">
							</div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<div class="input-group">
								 <span class="input-group-addon"><i class="fa fa-lock"></i></span>
								 <input type="password" class="form-control" name="passwordNew"  onkeypress="return soloNumeros(event)">
							</div>
						</div>
					</div>
					<!-- Campo Contraseña Nueva Again -->
					<div class="form-group">
						<label for="celular" class="col-sm-3 control-label">Repetir Contraseña </label>
						<div class="col-sm-8">
							<div class="input-group">
								 <span class="input-group-addon"><i class="fa fa-lock"></i></span>
								 <input type="password" class="form-control" name="celular" onkeypress="return soloNumeros(event)">
							</div>
						</div>
					</div>
				</div>
