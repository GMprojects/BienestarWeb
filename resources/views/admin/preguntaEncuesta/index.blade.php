...
<div class="box box-info">
	<div class="box-header">
		<div class="row">
			<div class="col-xs-6">
				<h3 class="box-title">Preguntas de Encuesta </h3>
			</div>
			<div class="col-xs-6" style="text-align:right;">
				<a href="{{ action('PreguntaEncuestaController@create',['idEncuesta' => $idEncuesta ])}}"><button class="btn btn-ff-green"><i class="fa fa-plus"></i>Nueva Pregunta</button></a>
			</div>
		</div>
	</div>
	...
	<div class="box-body">
			<div class="table">
					<div class="table-responsive">
							<table id="tabPreguntaEncuesta" class="table table-bordered table-striped table-hover dt-responsive nowrap" cellspacing="0" width="100%">
								<thead>
									<th>Id</th>
									<th>Enunciado</th>
									<th>Opciones</th>
