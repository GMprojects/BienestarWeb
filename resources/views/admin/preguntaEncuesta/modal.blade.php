<div class="modal fade modal-slide-in-right" aria-hidden="true" role="dialog" tabindex="-1" id="modal-delete-{{$preguntaEncuesta->idPreguntaEncuesta}}">
	{{Form::Open(['action'=>['PreguntaEncuestaController@destroy',$preguntaEncuesta->idPreguntaEncuesta],'method'=>'delete'])}}
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title"><b>Eliminar Pregunta</b></h4>
			</div>
			<div class="modal-body">
				<p>Confirme si desea ELIMINAR la pregunta </p>
				<p><b>"{{$preguntaEncuesta->enunciado}}"</b></p>
			</div>
