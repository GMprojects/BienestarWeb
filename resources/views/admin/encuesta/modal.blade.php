<div class="modal fade modal-slide-in-right" aria-hidden="true" role="dialog" tabindex="-1" id="modal-delete-{{$encuesta->idEncuesta}}">
	{{Form::Open(['action'=>['EncuestaController@destroy',$encuesta->idEncuesta],'method'=>'delete'])}}
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<p>
					Confirme si desea ELIMINAR la Encuesta de {{$encuesta->tipoActividad['tipo']}} para
					@if($encuesta->destino == 'r') Responsable  @else Isncrito @endif
				</p>
			</div>
