         ...
         <section id="page-content-wrapper" class="content-princ container">
            ...
            <div class="row" style="margin-left:0px; margin-right:0px; margin-top: -20px;">
               <ol class="breadcrumb">
                  ...
                  <li class="active">Actividad12</li>
               </ol>
            </div>
            <div class="row">
               <section class="organizadores col-md-3">
                  <div class="panel panel-default hidden-sm hidden-xs">
                     <div class="panel-heading">
                        <h3 class="panel-title">Organizadora</h3>
                     </div>
                     <div class="member">
                        ...
                        <div class="member-data">
                           <div class="member-name"><a href="#">Gaby Alvarez</a></div>
                           <div class="member-email"><a href="#">galvarezc@unitru.edu.pe</a></div>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="panel panel-default">
                     ...
                     <div class="member">
                        <div class="member-img pull-left">
                           <a href="#"><img src="{{ asset('img/avatar2.png') }}" alt="Not found" class="img-circle"></a>
                        </div>
                        <div class="member-data">
                           <div class="member-name"><a href="#"></i>María Guevara</a></div>
                           <div class="member-email"><a href="#">mguevaral@unitru.edu.pe</a></div>
                        </div>
                     </div>
                  </div>
