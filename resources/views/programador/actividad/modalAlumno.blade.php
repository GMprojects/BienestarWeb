	...
	<div class="modal-dialog">
		...
		<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title"><i class="flaticon-answer" style="font-size:5%;"></i>&nbsp; &nbsp;<b>Seleccionar al Alumno</b></h4>
				</div>
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-ff" onclick="agregar()" data-dismiss="modal"> <i class="fa fa-save"></i>Seleccionar</button>
