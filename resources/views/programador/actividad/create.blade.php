			...
			<div class="box-body">
				<div class="col-md-6">
					<div id="selectResponsables" style='display:none;'>
						<div class="form-group">
							<label for="idUserResponsable" id="etiquetaResponsable">Responsable *</label>
							<select name="idUserResponsable" id="selectIdResponsable" class="selectpicker form-control" data-size="15" data-live-search="true" data-show-subtext="true"> </select>
